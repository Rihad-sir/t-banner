...
updatedw() {
        ...
        then
                ...
                then
                        ...
                        clear && echo \"Already running the latest version!!\" && echo ------------------------------------- && figlet \$(sed '1q;d' 'ver.cfg') && figlet Rihad
                        ...
                        clear && echo \"Update Success\" && echo -------------- && figlet Success && figlet \$(sed '1q;d' 'ver.cfg') && figlet Rihad && echo Restart to apply changes
                ...
                echo \"Update Success\" && echo -------------- && figlet Success && figlet \$(sed '1q;d' '/data/data/com.termux/files/home/t-banner/ver.cfg') && figlet Rihad && echo Restart to apply changes
...
then
        ...
        if grep -q '# 011' \"/data/data/com.termux/files/home/T-banner/.user.cfg\"

        then

                lnum=\$( sed '3q;d' \"/data/data/com.termux/files/home/T-banner/.user.cfg\" )

                lnum=\$( echo \$lnum | sed 's/# 011//g' )

                lnum=\$( echo \$lnum | sed 's/ //g' )

                echo \$( sed '3q;d' \"/data/data/com.termux/files/home/T-banner/.user.cfg\" )
                        ...
                        then
                                ...
                                sed -i \"/.*# 011.*/ c\\ \$lnum # 011\" \"/data/data/com.termux/files/home/T-banner/.user.cfg\"
                ...
                echo \"1 # 011\" >> \"/data/data/com.termux/files/home/T-banner/.user.cfg\"
